        ...
        do {
            ...
            switch (option) {
                case 'c':
                    ...
                    String identificacion = verificados[0],
                     nombre = verificados[1],
                     contraseña = verificados[2],
                     telefono = "";
                    ...
                    do {
                        ...
                        if (!nacimiento.matches("[0-9]{2}\\/[0-9]{2}\\/[0-9]{4}")) {
                            continue;
                        }
